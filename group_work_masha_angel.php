...
<div class="container">
    ...
    <h2> Group Work Angel 2016 </h2>
    
    <a href="?logout=1" >Log out</a>
    
    <br>

    <a href="table_b.php">Link to table</a>
    
    <br>
    
    <a href="table_c.php">Our current possibilities</a>
    ...
    <form method="get">
        ...
        <h2>Would like to get info about</h2>
...
<h2>Find out current possibilities</h2>
<form>
